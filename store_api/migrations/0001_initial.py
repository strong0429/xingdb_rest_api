# Generated by Django 3.0.3 on 2020-02-22 03:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wechat', models.CharField(blank=True, max_length=256, null=True, unique=True, verbose_name='微信')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('app_name', models.CharField(max_length=32, unique=True, verbose_name='APP名称')),
                ('ver_code', models.PositiveIntegerField(verbose_name='版本号')),
                ('ver_txt', models.CharField(max_length=8, verbose_name='版本描述')),
                ('date_pub', models.DateTimeField(auto_now_add=True, verbose_name='发布日期')),
                ('detail', models.TextField(blank=True, null=True, verbose_name='版本描述')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=45, verbose_name='店铺名称')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('position', models.CharField(choices=[('OW', '店主'), ('CL', '店员'), ('MA', '经理')], default='CL', max_length=16)),
                ('date_joined', models.DateTimeField(auto_now_add=True, verbose_name='入职日期')),
                ('is_active', models.BooleanField(default=True)),
                ('staff', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='stores', to=settings.AUTH_USER_MODEL)),
